...
int main(int argc, char *argv[])
{
    ...
    while(true)
    {
        ...
        if(req[0]==0)
        {
            ...
            *	****THIS WAS VERY WRONG, FIXED FOR THE MOST PART BELOW
				*/
				printf("STUFF: %d-(%d*%d/%d))",k,sizes[2],vertex_total,block_total);
				printf("\n\nPRINTING K: %d\t\t\t\t other: %d\n",k,k-(sizes[2]*(int)ceil((vertex_total*1.0)/block_total)));
